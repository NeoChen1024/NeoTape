...
NEOTAPE_WRITE_OBJS = src/neotape_write_cmd.o src/neotape_signature.o src/neotape_tcp_protocol.o src/neotape_tape.o src/neotape_format.o src/neotape_common.o src/neotape_socket_util.o
